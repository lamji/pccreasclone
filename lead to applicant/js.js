...
// frappe.ready(function() {
    ...
    const personal_info_Tab = `
				...
				<form>
					...
					<div class="form-group col-md-3 c-mb-sm-1">
						...
						<div class="form-group col-md-3 c-mb-sm-1">
							...
							<input type="text" class="form-control form-control-sm border bg-white rounded-0 border-dark" id="home_phone" placeholder="Enter your Home Phone Number">
						</div>
						<div class="form-group col-md-3 ">
		...
		<div class="container text12">
			<form>
				...
				<div class="form-group col-md-3 c-mb-sm-1">
					<label for="father_name">Father's Last Name <span class="text-red f-req"> *</span></label>
				...
				<div class="form-group col-md-3 c-mb-sm-1">
					<label for="father_first_name">Father's First Name <span class="text-red f-req"> *</span></label>
				...
				<div class="form-group col-md-3 c-mb-sm-1">
					<label for="father_middle_name">Father's Middle Name <span class="text-red f-req"> *</span></label>
				...
				<div class="form-row mother">
					<div class="form-group col-md-3 c-mb-sm-1">
						<label for="mother_name">Mother's Last Name <span class="text-red m-req"> *</span></label>
					...
					<div class="form-group col-md-3 c-mb-sm-1">
						<label for="mother_first_name">Mother's First Name <span class="text-red m-req"> *</span></label>
					...
					<div class="form-group col-md-3">
						<label for="mother_middle_name">Mother's Middle Name <span class="text-red m-req"> *</span></label>
		                ...
		                <div class="form-group col-md-9  d-flex">
		                    ...
		                    <div class="col-md-6 p-0" >
		                        ...
		                        <div class="input-group mb-0">
		                          <input type="text" class="form-control py-1 check_value form-control form-control-sm border bg-white rounded-0 border-dark" id="prof" disabled placeholder="Upload File" aria-label="Upload File" aria-describedby="basic-addon1">
		...
		$('#father_middle_name, #father_first_name, #father_name').click( () => {
     		console.log("change")
     		let r_father_name = $('#father_name').val();
	        let r_father_first_name = $('#father_first_name').val();
	        let r_father_middle_name = $('#father_middle_name').val();
	        if (r_father_middle_name || r_father_first_name || r_father_name){
	        	$('.m-req').hide()
	        }else{
	        	$('.m-req').show()
	        }
     	...
     	$('#mother_middle_name, #mother_first_name, #mother_name').click( () => {
     		console.log("change")
     		let r_mother_name = $('#mother_name').val();
	        let r_mother_first_name = $('#mother_first_name').val();
	        let r_mother_middle_name = $('#mother_middle_name').val();
	        if (r_mother_middle_name || r_mother_first_name || r_mother_name){
	        	$('.f-req').hide()
	        }else{
	        	$('.f-req').show()
	        }
		...
		$('#province').change(function() {
			...
			console.log(province)	
			 frappe.web_form.set_value('province_code', province)
			$('#city')
			.empty()
		...
		$('#city, .city_temp').change(function() {
			...
			frappe.web_form.set_value('city_code', city)
			$('#barangay')
			.empty()
		...
		// 	console.log(res)
		// 	//location api
		// 	$('#city option').html(`<option class="city_temp" selected="" disabled="">${res.data.municipalitycity}</option>`)
		// 	$('#barangay option').html(`<option class="bragy_temp" selected="" disabled="">${res.data.barangay}</option>`)
		// 	$('#province option').html(`<option class="province_temp" selected="" disabled="">${res.data.province}</option>`)
	 ...
	 //        $('#city').val(res.data.municipalitycity)
		// 	$('#barangay').val(res.data.barangay)
	 //        // $('#guardianProof').val(res.data.supporting_documents);
	 //        $('#first_name').val(res.data.first_name);
		...
		$('.go_to_background').click( () => {
			...
			if(sd.includes("/files/")){
				console.log(sd)
			}
			
			let city_temp = $('.city_temp').val()
			let brgy_temp = $('.bragy_temp').val()
	        ...
	        city = $('#city').val();
	       	console.log(city)
	       	console.log(barangay, province)
	       	if(city == null || barangay == null || province == null ){
	        	city = $('.city_temp').val()
	        	console.log(city)
	        	barangay = $('.bragy_temp').val()
	        	province = $('.province_temp').val();
	       		console.log(barangay,brgy_temp + "hahah")
	       	}else{
  				barangay = $('#barangay').val();
	        	city = $('#city').val();
	       	}
	        ...
	        let uploadImage = async()=>{
		    	...
		    	.then(res => {
					...
					.then(res => {
						console.log(res)
						if(res.message){
							frappe.web_form.set_df_property("supporting_documents", "reqd", 0)
						}
					})
		    	})
		    }
            ...
            //disable required
	        if(father_first_name || father_middle_name || father_name){
				...
				$('.m-req').html("")
	        }else if(mother_name || mother_middle_name || mother_first_name){
        	...
        	if(living == "yes"){
            	...
            	console.log("living no")
            	let guardian = $('#guardianProof').val()
			   	console.log(" Guardian: " + guardian)
			   	if(guardian){
	   				frappe.web_form.set_df_property("supporting_documents", "reqd", 0)
			   	}else{
			   		frappe.web_form.set_df_property("supporting_documents", "reqd", 1)
			   	}
            	frappe.web_form.set_df_property("full_name_of_guardian", "reqd", 1)
				frappe.web_form.set_df_property("relationship", "reqd", 1)
				frappe.web_form.set_df_property("contact_number", "reqd", 1)
				frappe.web_form.set_df_property("reason_for_guardianship", "reqd", 1)
            ...
            function checkInp(){
			    ...
			    {
			        var newhome_phone = $('#home_phone').val("Not Applicable");
			        frappe.web_form.set_value('home_phone_number', "Not Applicable")
			        return false;
			    }
			}
			checkInp()
		    ...
		    if(email && mobile_number && guardian_number){
		    	if(email_validatoin == false){
		    		frappe.throw("Invalid Email")
		    	}else if(mobile_number.length != 11){
		    		frappe.throw("Invalid format. Mobile number must be 11 digit")
		    	}else if (guardian_number.length != 11){
		    		frappe.throw("Invalid format. Guardian mobile number must be 11 digit")
		    	}else{
		    		setTimeout(function () {
	...
	frappe.web_form.after_save = () => {
		 window.location.href = "/educational-background-form"
	}
// })
