            ...
            <div class="row px-0">
                ...
                <div class="col-md-8 text12 pl-0" style="display: none;">
					...
					<div class="d-flex sm-button justify-content-center">
						<div id="back_to_step1" class="back btn cursor-pointer border boder-0 mx-2 py-1 px-3">Back</div>
						<div id="show-button" class="btn sm-show-button continue cursor-pointer border btn-primary boder-0 mr-2 py-1 px-3">Continue</div>
						<div id="hide-button" class="btn sm-hide-buttoncursor-not-allowed border btn-secondary boder-0 mr-2 py-1 px-3">Continue</div>
					</div>
                </div>
            </div>
