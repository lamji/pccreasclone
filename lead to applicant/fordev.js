...
.then(r => {
  console.log(r)
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title text-red" id="exampleModalLabel">Error</h5>
    ...
    var guardian_number =""
    // const func = async()=> {
    //  let res = await fetch('https://api.psgc.abakadastudios.com/api/provinces/'+ "Tarlac"+'?per_page=all&include=municipalities,cities')
    //  .then(response => response.json())
    //  .then(data => {
    //    return data
    ...
    .then(res => {
      ...
      $('#province option').html(`<option class="city_temp" selected="" disabled="">${res.data.province}</option>`)
    ...
    $('.go_to_background').click( () => {
      ...
      console.log(barangay, Age_as,mother_tongue,middle_name,last_name,first_name,
        guardianProof,reason,relationship,guardian_name,guardian_number,mother_middle_name,
        mother_first_name,mother_name,father_suffix,father_name,father_first_name,father_middle_name,
        father_first_name,province,address,email,home_phone, "mobile_number:" + mobile_number,
        "religion:" + religion, "ethnic: " + ethnic, "birthday:" + birthday, " gender: "+gender,
      ...
      if(last_name || first_name || middle_name){
       console.log("save the data")
         ...
         const error_logs = `
          <p class="log_f_name error_val2">Last Name<p>
          <p class="log_l_name error_val2">First Name<p>
          <p class="log_m_name error_val2">Middle Name<p>
        `
        $('#exampleModal').modal('show')

        $('.error_val').append(error_logs)
      }
