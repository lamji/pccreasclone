frappe.web_form.after_load = () => {
	...
	<div class="container tab mb-5 text12">
	  ...
	  <h5 class="my-4">Admission Requirements</h5>
	...
	$('.container.my-4').before(add_requirements_tab)
	...
	.then(res => {
		...
		// end of hidding pages
		// Retrive submitted requirements
		const data = res.data
		...
		$('.loader').hide()
		//end of Retrive submitted requirements
		...
		.then(res => {
			...
			console.log(acad_dept2 + " : " + Student_Type)
	...
	$("#section").change( () => {
	    ...
	    if(section === "Choose Section"){
	        ...
	        $('#t-list td').hide()
	        //Table List
	        fetch('/api/resource/Sections/' + section)
	        .then(res => res.json())
	        .then(res => {
