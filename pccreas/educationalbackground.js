	...
	$('.continue_to_confirmation').click( () => {
		if(acad_value == "D05"){
			...
			if(pre_school_array.length == 0){
				frappe.throw("Pre School Must Not Empty")
			}else if(Gs_pre_school_array.length == 0){
				frappe.throw("Grade School Must Not Empty")
			}else{
			...
			if(shs_ps_array.length == 0){
				...
				frappe.throw("Junior High School Must Not Empty")
			}else{
				console.log("save the data")
				location.replace('/confirmation-lead')
			}
			...
			if(college_ps_array.length == 0){
				...
				frappe.throw("Senior High School Must Not Empty")
			}else{
				console.log("save the data")
				location.replace('/confirmation-lead')
			}
			...
			if(college_ps_array.length == 0){
				...
				frappe.throw("Graduate School Must Not Empty")
			}else{
				console.log("save the data")
				location.replace('/confirmation-lead')
			}
